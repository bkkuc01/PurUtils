...
public class MariaDB implements DataBase, Connectable {
    ...
    public MariaDB(@NotNull String host, @NotNull String port, @NotNull String username, @NotNull String password, @NotNull String databaseName) {
        this.host = host;
        this.port = port;
